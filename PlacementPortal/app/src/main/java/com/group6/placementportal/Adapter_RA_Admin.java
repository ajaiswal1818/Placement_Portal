...
Adapter_RA_Admin extends RecyclerView.Adapter<Adapter_RA_Admin.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.nature_of_work.setText(profiles.get(position).getType_of_Job());
        holder.designation.setText(profiles.get(position).getDesignation());
...
//                context.startActivity(intent);
    ...
    {
        TextView name_of_org,student_name,nature_of_work,designation;
        ...
        public MyViewHolder(View itemView) {
            ...
            nature_of_work = itemView.findViewById(R.id.txt_nature_of_works);
            designation = itemView.findViewById(R.id.txt_designations);
