...
public class View_Interns extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    private DatabaseReference reference;
    private RecyclerView recyclerView;
    private ArrayList<Interns> list;
    private MyAdapter_intern adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new MyAdapter_intern(View_Interns.this ,list ,user);
    ...
    private void updateSignedOutUI() {
        flag=1;
        Intent intent = new Intent(View_Interns.this,LoginPage.class);
        intent.putExtra("flag",flag);
        startActivity(intent);
        exit();
    }
    private void exit(){
        View_Interns.this.finish();
    }
}
