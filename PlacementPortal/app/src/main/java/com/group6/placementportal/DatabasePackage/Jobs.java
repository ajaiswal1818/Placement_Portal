...
public class Jobs {
    ...
    public Jobs(int job_id, String profile, float ctc, String location, String brochure, String company_id, String company_name, String branches, float cutoff_cpi) {
        this.job_id = job_id;
