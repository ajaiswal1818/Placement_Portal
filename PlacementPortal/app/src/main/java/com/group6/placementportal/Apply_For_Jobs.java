...
public class Apply_For_Jobs extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference(net.simplifiedlearning.firebasestorage.Constants.DATABASE_PATH_UPLOADS);
