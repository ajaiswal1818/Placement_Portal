...
public class MyAdapter_intern extends RecyclerView.Adapter<MyAdapter_intern.MyViewHolder> {

    Context context;
    ArrayList<Interns> profiles;
    Student user;

    public MyAdapter_intern(Context c , ArrayList<Interns> p, Student student)
    {
        context = c;
        profiles = p;
        user = student;
    ...
    class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(View itemView) {
            ...
            intern_profile = itemView.findViewById(R.id.txt_job_profile);
            intern_location = itemView.findViewById(R.id.txt_job_location);
